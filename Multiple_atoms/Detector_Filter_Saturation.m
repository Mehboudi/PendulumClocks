...
%threshhold=1;
ti=[0,tvec_dN1];
n=10;%This number should be an integer above 3. It's value doesn't matter, but larger n makes the code slower, instead the currents look smoother. Accuracy is not affected.
I2=[];
tt=[];
...
%%
%plot the currents
if plot_filter==1 && ismember(iM,plotindices)
    figure(30)
